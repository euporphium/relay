...
export const TaskFormBody = withForm({
  defaultValues: {
    name: '',
    note: '',
        ...
        {(field) => (
          ...
          >
            ...
            <FieldSet>
              ...
              <FieldDescription>
                Determine if the next suggestion should follow a strict calendar
                or shift based on your activity.
              </FieldDescription>
              ...
              >
                ...
                <FieldLabel htmlFor="anchor-completion">
                  <Field orientation="horizontal" className="py-1">
                    ...
                    <RadioGroupItem value="completion" id="anchor-completion" />
                  </Field>
                </FieldLabel>
              </RadioGroup>
            </FieldSet>
